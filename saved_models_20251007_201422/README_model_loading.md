...
lstm_model = load_model('saved_models_20251007_201422/lstm_model.h5')
with open('saved_models_20251007_201422/lstm_tokenizer.pickle', 'rb') as f:
    tokenizer = pickle.load(f)
label_encoder = joblib.load('saved_models_20251007_201422/label_encoder.joblib')

# Load classical models and preprocessors
random_forest_model = joblib.load('saved_models_20251007_201422/random_forest_model.joblib')
svm_model = joblib.load('saved_models_20251007_201422/svm_model.joblib')
tfidf_vectorizer = joblib.load('saved_models_20251007_201422/tfidf_vectorizer.joblib')
scaler = joblib.load('saved_models_20251007_201422/standard_scaler.joblib')
```
